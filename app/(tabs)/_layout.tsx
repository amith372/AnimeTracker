...
// nav instead — same Tabs/routes underneath, just a row layout with WebSidebar as a sibling and
// the native bottom bar hidden, so it flips back automatically on narrow web / native.
